...
- CMC https://arxiv.org/pdf/1906.05849.pdf (Memory Bank, Augmentation Task (We use CPC Aufs), Multimodal)
  Features Only from L channel as in theory, the embeddings should be close anyway
- BYOL (CL via BN) https://arxiv.org/pdf/2006.07733.pdf (No negatives, Augmentation task, Target and Projection head, 2 Backbones, Temperature)
