...
class MBConvBlock(nn.Module):
    ...
    def __init__(self, block_args, global_params, image_size=None, norm_type='batch'):
        super().__init__()
        ...
        if self._block_args.expand_ratio != 1:
            ...
            if norm_type == 'layer':
                self._bn0 = LayerNorm2d(features=oup)
            else:
        ...
        if norm_type == 'layer':
            self._bn1 = LayerNorm2d(features=oup)
        else:
        ...
        if norm_type == 'layer':
            self._bn2 = LayerNorm2d(features=final_oup)
        else:
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None, norm_type='batch'):
        super().__init__()
        ...
        if norm_type == 'layer':
            self._bn0 = LayerNorm2d(features=out_channels)
        else:
            self._bn0 = nn.BatchNorm2d(
        ...
        for block_args in self._blocks_args:
            ...
            self._blocks.append(MBConvBlock(
                block_args, self._global_params, image_size=image_size, norm_type=norm_type))
    ...
    @ classmethod
    def from_name(cls, model_name, in_channels=3, norm_type='batch', **override_params):
        ...
        model = cls(blocks_args, global_params, norm_type=norm_type)
